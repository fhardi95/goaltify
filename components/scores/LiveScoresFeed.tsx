...
import { getMatchStatus, TOURNAMENT_COMPETITION_IDS } from '@/lib/api-football'
...
export function LiveScoresFeed() {
  ...
  const competitionId     = TOURNAMENT_COMPETITION_IDS[tournament]
  const tournamentFiltered = competitionId
    ? matches.filter(m => m.league.id === competitionId)
    : matches
