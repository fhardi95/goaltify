...
import { getAllSlugs } from '@/app/_data/blog-data'
...
// ── BLOG posts — auto-generated from blog-data.ts ─────────────────────────
// Add a new BlogPost to BLOG_POSTS in app/_data/blog-data.ts and it
...
// ── NEWS articles — auto-generated from content/articles/*.md(x) ──────────
// Drop a new markdown file into content/articles/ and it appears in the
// sitemap automatically. The lastModified date is read from the article's
// modifiedAt or publishedAt frontmatter field for accurate indexing signals.
function getNewsPages(): MetadataRoute.Sitemap {
  try {
    ...
    // getAllArticles returns [] when content/articles doesn't exist yet
    return []
  }
}
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...STATIC_PAGES,
    ...getBlogPages(),   // ← auto from blog-data.ts
    ...getNewsPages(),   // ← auto from content/articles/*.md(x)
    ...COMPETITION_PAGES,
    ...TEAM_PAGES,
    ...PLAYER_PAGES,
    ...DRIBBLING_GUIDES,
