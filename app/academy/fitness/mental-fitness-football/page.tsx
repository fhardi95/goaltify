...
const CANONICAL = 'https://goaltify.com/academy/fitness/mental-fitness-football'

export const metadata: Metadata = buildMetadata({
  title: 'Mental Fitness for Footballers',
  description: 'Concentration, confidence and handling pressure on the pitch. The mental side of football explained with practical techniques used by professionals.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Mental Fitness for Footballers', description: 'Concentration, confidence and handling pressure on the pitch. The mental side of football explained with practical techniques used by professionals.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Mental Fitness for Footballers</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Mental Fitness for Footballers</h1>
        <p className="text-gray-400 leading-relaxed">Concentration, confidence and handling pressure on the pitch. The mental side of football explained with practical techniques used by professionals.</p>
