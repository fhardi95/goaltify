...
const CANONICAL = 'https://goaltify.com/academy/fitness/recovery-after-a-match'

export const metadata: Metadata = buildMetadata({
  title: 'How to Recover Properly After a Football Match',
  description: 'What to eat, when to rest, and the recovery techniques used by professional players to bounce back faster after a game.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'How to Recover Properly After a Football Match', description: 'What to eat, when to rest, and the recovery techniques used by professional players to bounce back faster after a game.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">How to Recover Properly After a Football Match</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">How to Recover Properly After a Football Match</h1>
        <p className="text-gray-400 leading-relaxed">What to eat, when to rest, and the recovery techniques used by professional players to bounce back faster after a game.</p>
