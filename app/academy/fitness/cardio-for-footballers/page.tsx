...
const CANONICAL = 'https://goaltify.com/academy/fitness/cardio-for-footballers'

export const metadata: Metadata = buildMetadata({
  title: 'Cardio Training for Footballers: Beyond the Jog',
  description: 'Why steady-state jogging is not enough for football. Interval and high-intensity training plans that mirror real match demands.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Cardio Training for Footballers: Beyond the Jog', description: 'Why steady-state jogging is not enough for football. Interval and high-intensity training plans that mirror real match demands.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Cardio Training for Footballers: Beyond the Jog</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Cardio Training for Footballers: Beyond the Jog</h1>
        <p className="text-gray-400 leading-relaxed">Why steady-state jogging is not enough for football. Interval and high-intensity training plans that mirror real match demands.</p>
