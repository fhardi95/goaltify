...
const CANONICAL = 'https://goaltify.com/academy/dribbling/how-to-take-a-free-kick'
  ...
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">How to Take a Free Kick Like a Pro</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">How to Take a Free Kick Like a Pro</h1>
        <p className="text-gray-400 leading-relaxed">Placement, dipping technique, power and set-piece strategy. Everything you need to become your team's free-kick specialist.</p>
