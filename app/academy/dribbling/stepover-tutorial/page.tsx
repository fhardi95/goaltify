...
const CANONICAL = 'https://goaltify.com/academy/dribbling/stepover-tutorial'

export const metadata: Metadata = buildMetadata({
  title: 'Stepover Tutorial: Master the Classic Move',
  description: 'Step-by-step breakdown of the single, double and reverse stepover. Includes drills to practise alone and use in matches.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Stepover Tutorial: Master the Classic Move', description: 'Step-by-step breakdown of the single, double and reverse stepover. Includes drills to practise alone and use in matches.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Stepover Tutorial: Master the Classic Move</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Stepover Tutorial: Master the Classic Move</h1>
        <p className="text-gray-400 leading-relaxed">Step-by-step breakdown of the single, double and reverse stepover. Includes drills to practise alone and use in matches.</p>
