...
const CANONICAL = 'https://goaltify.com/academy/dribbling/how-to-nutmeg'
  ...
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">How to Nutmeg: The Art of the Panna</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">How to Nutmeg: The Art of the Panna</h1>
        <p className="text-gray-400 leading-relaxed">When to nutmeg, how to set it up, and the exact technique to thread the ball between a defender's legs reliably.</p>
