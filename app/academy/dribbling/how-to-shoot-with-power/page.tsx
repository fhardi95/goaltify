...
const CANONICAL = 'https://goaltify.com/academy/dribbling/how-to-shoot-with-power'

export const metadata: Metadata = buildMetadata({
  title: 'How to Shoot with Power and Accuracy',
  description: 'The correct shooting technique, the most common mistakes, and practice drills to develop a more powerful and accurate shot.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'How to Shoot with Power and Accuracy', description: 'The correct shooting technique, the most common mistakes, and practice drills to develop a more powerful and accurate shot.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">How to Shoot with Power and Accuracy</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">How to Shoot with Power and Accuracy</h1>
        <p className="text-gray-400 leading-relaxed">The correct shooting technique, the most common mistakes, and practice drills to develop a more powerful and accurate shot.</p>
