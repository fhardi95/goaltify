...
const CANONICAL = 'https://goaltify.com/academy/training/football-diet-plan'

export const metadata: Metadata = buildMetadata({
  title: 'Football Diet Plan: What to Eat and When',
  description: 'Pre-match meals, post-match recovery nutrition and hydration advice for amateur and semi-pro footballers.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Football Diet Plan: What to Eat and When', description: 'Pre-match meals, post-match recovery nutrition and hydration advice for amateur and semi-pro footballers.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Football Diet Plan: What to Eat and When</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Football Diet Plan: What to Eat and When</h1>
        <p className="text-gray-400 leading-relaxed">Pre-match meals, post-match recovery nutrition and hydration advice for amateur and semi-pro footballers.</p>
