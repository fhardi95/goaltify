...
const CANONICAL = 'https://goaltify.com/academy/training/strength-training-for-footballers'

export const metadata: Metadata = buildMetadata({
  title: 'Strength Training for Footballers',
  description: 'Build functional strength that translates directly to power, shielding and aerial ability on the pitch. A complete programme for footballers.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Strength Training for Footballers', description: 'Build functional strength that translates directly to power, shielding and aerial ability on the pitch. A complete programme for footballers.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Strength Training for Footballers</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Strength Training for Footballers</h1>
        <p className="text-gray-400 leading-relaxed">Build functional strength that translates directly to power, shielding and aerial ability on the pitch. A complete programme for footballers.</p>
