...
const CANONICAL = 'https://goaltify.com/academy/training/speed-training-drills'

export const metadata: Metadata = buildMetadata({
  title: 'Speed Training Drills for Footballers',
  description: 'Targeted speed and agility drills to improve your acceleration, top speed and quickness on the football pitch.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Speed Training Drills for Footballers', description: 'Targeted speed and agility drills to improve your acceleration, top speed and quickness on the football pitch.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Speed Training Drills for Footballers</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Speed Training Drills for Footballers</h1>
        <p className="text-gray-400 leading-relaxed">Targeted speed and agility drills to improve your acceleration, top speed and quickness on the football pitch.</p>
