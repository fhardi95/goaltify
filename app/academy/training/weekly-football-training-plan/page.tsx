...
const CANONICAL = 'https://goaltify.com/academy/training/weekly-football-training-plan'

export const metadata: Metadata = buildMetadata({
  title: '7-Day Football Training Plan',
  description: 'A complete weekly training schedule balancing technical work, fitness, rest and recovery for amateur footballers.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: '7-Day Football Training Plan', description: 'A complete weekly training schedule balancing technical work, fitness, rest and recovery for amateur footballers.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">7-Day Football Training Plan</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">7-Day Football Training Plan</h1>
        <p className="text-gray-400 leading-relaxed">A complete weekly training schedule balancing technical work, fitness, rest and recovery for amateur footballers.</p>
