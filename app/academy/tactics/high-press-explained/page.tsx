...
const CANONICAL = 'https://goaltify.com/academy/tactics/high-press-explained'
  ...
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">High Press in Football: How It Works</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">High Press in Football: How It Works</h1>
        <p className="text-gray-400 leading-relaxed">The triggers, player roles and risk-reward of the high press — from Klopp's Liverpool to Guardiola's City explained simply.</p>
