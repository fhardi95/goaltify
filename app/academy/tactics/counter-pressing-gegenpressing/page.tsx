...
const CANONICAL = 'https://goaltify.com/academy/tactics/counter-pressing-gegenpressing'

export const metadata: Metadata = buildMetadata({
  title: 'Counter-Pressing (Gegenpressing): The Complete Guide',
  description: 'Klopp made it famous. Here is the exact mechanics of gegenpressing — how to win the ball back in 5 seconds and why it works.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'Counter-Pressing (Gegenpressing): The Complete Guide', description: 'Klopp made it famous. Here is the exact mechanics of gegenpressing — how to win the ball back in 5 seconds and why it works.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">Counter-Pressing (Gegenpressing): The Complete Guide</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">Counter-Pressing (Gegenpressing): The Complete Guide</h1>
        <p className="text-gray-400 leading-relaxed">Klopp made it famous. Here is the exact mechanics of gegenpressing — how to win the ball back in 5 seconds and why it works.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
        <Link href="/academy/tactics" className="card p-4 hover:border-gray-700 transition-colors group">
          <p className="text-xs text-brand-400 mb-1">← Back to Tactics</p>
          <p className="text-sm font-medium text-white group-hover:text-brand-400">All Tactics guides</p>
        </Link>
