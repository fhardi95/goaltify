...
const CANONICAL = 'https://goaltify.com/academy/tactics/how-to-defend-set-pieces'

export const metadata: Metadata = buildMetadata({
  title: 'How to Defend Set Pieces in Football',
  description: 'Zonal vs man marking, organising your wall, defending corners and free kicks — a complete set piece defensive guide.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: 'How to Defend Set Pieces in Football', description: 'Zonal vs man marking, organising your wall, defending corners and free kicks — a complete set piece defensive guide.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">How to Defend Set Pieces in Football</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">How to Defend Set Pieces in Football</h1>
        <p className="text-gray-400 leading-relaxed">Zonal vs man marking, organising your wall, defending corners and free kicks — a complete set piece defensive guide.</p>
