...
const CANONICAL = 'https://goaltify.com/academy/tactics/4-4-2-formation-guide'

export const metadata: Metadata = buildMetadata({
  title: '4-4-2 Formation: The Classic Revisited',
  description: 'Why the 4-4-2 never died and how modern teams use it. Player roles, pressing shape, and how it compares to the 4-3-3.',
  canonical: CANONICAL,
})

export default function Page() {
  const schema = buildArticleSchema({ title: '4-4-2 Formation: The Classic Revisited', description: 'Why the 4-4-2 never died and how modern teams use it. Player roles, pressing shape, and how it compares to the 4-3-3.', canonical: CANONICAL, publishedAt: '2026-05-10' })
  return (
    <div className="container-site py-8 max-w-4xl">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-5">
        ...
        <span className="text-gray-400">4-4-2 Formation: The Classic Revisited</span>
      </nav>
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight mt-3 mb-3">4-4-2 Formation: The Classic Revisited</h1>
        <p className="text-gray-400 leading-relaxed">Why the 4-4-2 never died and how modern teams use it. Player roles, pressing shape, and how it compares to the 4-3-3.</p>
