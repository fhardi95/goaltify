...
export const metadata: Metadata = buildMetadata({
  title: 'La Liga Table 2025/26 — Live Standings | Goaltify',
  description: 'La Liga 2025/26 standings table with points, goal difference, form and European qualification places.',
  canonical: 'https://goaltify.com/competitions/la-liga/standings',
  keywords: ['La Liga table', 'La Liga standings 2025/26', 'La Liga table today'],
})
