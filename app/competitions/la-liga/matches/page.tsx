...
export const metadata: Metadata = buildMetadata({
  title: 'La Liga Fixtures & Results 2025/26',
  description: 'All La Liga 2025/26 fixtures, results and kick-off times. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/la-liga/matches',
  keywords: ['La Liga fixtures', 'La Liga results', 'La Liga schedule 2025/26'],
})
export default async function LLMatches() {
