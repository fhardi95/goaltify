...
export const metadata: Metadata = buildMetadata({
  title: 'Serie A 2025/26 — Table, Fixtures & News | Goaltify',
  description: 'Serie A 2025/26 coverage. Live table, upcoming fixtures, results, top scorers and latest news on Goaltify.',
  canonical: 'https://goaltify.com/competitions/serie-a',
  keywords: comp.keywords,
})

export default async function SAOverview() {
        ...
        <div className="lg:col-span-2 space-y-6">
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/serie-a/standings" className="text-xs text-brand-400">Full table →</Link>
            </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/serie-a/matches" className="text-xs text-brand-400">All matches →</Link>
            </div>
        ...
        <aside className="space-y-4">
          ...
          <div className="card p-4">
            ...
            <div className="space-y-1.5">
              {[{label:'📊 Full standings',href:'/competitions/serie-a/standings'},{label:'⚽ Top scorers',href:'/competitions/serie-a/top-players'},{label:'📰 Latest news',href:'/competitions/serie-a/news'},{label:'🗓 All fixtures',href:'/competitions/serie-a/matches'}].map(l=>(
