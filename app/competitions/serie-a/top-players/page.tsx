...
export const metadata: Metadata = buildMetadata({
  title: 'Serie A Top Scorers 2025/26',
  description: 'Serie A 2025/26 top scorers, goals, assists and appearances. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/serie-a/top-players',
  keywords: ['Serie A top scorers', 'Serie A goals 2025/26', 'Serie A golden boot'],
})
export default async function SATopPlayers() {
