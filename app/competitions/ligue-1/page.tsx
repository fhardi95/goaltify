...
export const metadata: Metadata = buildMetadata({
  title: 'Ligue 1 2025/26 — Table, Fixtures & News | Goaltify',
  description: 'Ligue 1 2025/26 coverage. Live table, upcoming fixtures, results, top scorers and latest news on Goaltify.',
  canonical: 'https://goaltify.com/competitions/ligue-1',
  keywords: comp.keywords,
})

export default async function L1Overview() {
        ...
        <div className="lg:col-span-2 space-y-6">
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/ligue-1/standings" className="text-xs text-brand-400">Full table →</Link>
            </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/ligue-1/matches" className="text-xs text-brand-400">All matches →</Link>
            </div>
        ...
        <aside className="space-y-4">
          ...
          <div className="card p-4">
            ...
            <div className="space-y-1.5">
              {[{label:'📊 Full standings',href:'/competitions/ligue-1/standings'},{label:'⚽ Top scorers',href:'/competitions/ligue-1/top-players'},{label:'📰 Latest news',href:'/competitions/ligue-1/news'},{label:'🗓 All fixtures',href:'/competitions/ligue-1/matches'}].map(l=>(
