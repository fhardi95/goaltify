...
export const metadata: Metadata = buildMetadata({
  title: 'Ligue 1 Top Scorers 2025/26',
  description: 'Ligue 1 2025/26 top scorers, goals, assists and appearances. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/ligue-1/top-players',
  keywords: ['Ligue 1 top scorers', 'Ligue 1 goals 2025/26', 'Ligue 1 golden boot'],
})
export default async function L1TopPlayers() {
