...
export const metadata: Metadata = buildMetadata({
  title: 'Ligue 1 Fixtures & Results 2025/26',
  description: 'All Ligue 1 2025/26 fixtures, results and kick-off times. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/ligue-1/matches',
  keywords: ['Ligue 1 fixtures', 'Ligue 1 results', 'Ligue 1 schedule 2025/26'],
})
export default async function L1Matches() {
