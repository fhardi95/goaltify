...
export const metadata: Metadata = buildMetadata({
  title: 'Ligue 1 Table 2025/26 — Live Standings | Goaltify',
  description: 'Ligue 1 2025/26 standings table with points, goal difference, form and European qualification places.',
  canonical: 'https://goaltify.com/competitions/ligue-1/standings',
  keywords: ['Ligue 1 table', 'Ligue 1 standings 2025/26', 'Ligue 1 table today'],
})
