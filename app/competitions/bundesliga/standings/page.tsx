...
export const metadata: Metadata = buildMetadata({
  title: 'Bundesliga Table 2025/26 — Live Standings | Goaltify',
  description: 'Bundesliga 2025/26 standings table with points, goal difference, form and European qualification places.',
  canonical: 'https://goaltify.com/competitions/bundesliga/standings',
  keywords: ['Bundesliga table', 'Bundesliga standings 2025/26', 'Bundesliga table today'],
})
...
export default async function BLStandings() {
  const standings = await getStandings(comp.leagueId, comp.season)
  return (
    <CompetitionLayout competition={comp} activeTab="standings">
      <h2 className="text-lg font-bold text-white mb-4">Bundesliga Table — 2025/26</h2>
