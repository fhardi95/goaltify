...
export const metadata: Metadata = buildMetadata({
  title: 'Bundesliga Top Scorers 2025/26',
  description: 'Bundesliga 2025/26 top scorers, goals, assists and appearances. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/bundesliga/top-players',
  keywords: ['Bundesliga top scorers', 'Bundesliga goals 2025/26', 'Bundesliga golden boot'],
})
export default async function BLTopPlayers() {
