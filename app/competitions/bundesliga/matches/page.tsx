...
export const metadata: Metadata = buildMetadata({
  title: 'Bundesliga Fixtures & Results 2025/26',
  description: 'All Bundesliga 2025/26 fixtures, results and kick-off times. Updated daily on Goaltify.',
  canonical: 'https://goaltify.com/competitions/bundesliga/matches',
  keywords: ['Bundesliga fixtures', 'Bundesliga results', 'Bundesliga schedule 2025/26'],
})
export default async function BLMatches() {
