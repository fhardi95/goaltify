...
export const metadata: Metadata = buildMetadata({
  title: 'Bundesliga 2025/26 — Table, Fixtures & News | Goaltify',
  description: 'Bundesliga 2025/26 coverage. Live table, upcoming fixtures, results, top scorers and latest news on Goaltify.',
  canonical: 'https://goaltify.com/competitions/bundesliga',
  keywords: comp.keywords,
})

export default async function BLOverview() {
        ...
        <div className="lg:col-span-2 space-y-6">
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/bundesliga/standings" className="text-xs text-brand-400">Full table →</Link>
            </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/competitions/bundesliga/matches" className="text-xs text-brand-400">All matches →</Link>
            </div>
        ...
        <aside className="space-y-4">
          ...
          <div className="card p-4">
            ...
            <div className="space-y-1.5">
              {[{label:'📊 Full standings',href:'/competitions/bundesliga/standings'},{label:'⚽ Top scorers',href:'/competitions/bundesliga/top-players'},{label:'📰 Latest news',href:'/competitions/bundesliga/news'},{label:'🗓 All fixtures',href:'/competitions/bundesliga/matches'}].map(l=>(
